...
// team awesome--james huang and simon tsui
// APCS1 p01
...
public class Rational
{
  ...
  public boolean equals( Object other )
  {
	...
	Rational _other=(Rational) other;
	_other.reduce();
	if(this._numerator==_other._numerator && this._denominator==_other._denominator) {
	    return true;
    }
	return false;
    }
    else {
	throw new IllegalArgumentException("error, must be Rational var");
    }
  ...
  public static void main( String[] args )
  {
    //*~~~v~~~~~~~~~~down~goer~3~~~~~~~~~~~~~v~~~~~
      ...
      System.out.println("r: " + r );//3/7
      System.out.println("s: " +  s );//0/1
      System.out.println("t: " +  t );//8/5
      ...
      System.out.println( "r > t: " +  r.compareTo(t) );//r is smaller than t(good)
      System.out.println( "r > s: " +  r.compareTo(s) );//r is bigger than s
      System.out.println( "s > t: " +  s.compareTo(t) );//s is smaller than t
      //uncommenting the line below should trigger a runtime error
      // System.out.println( "s > y: " +  s.compareTo(y) );//it does
