...
//2018-3-4
/* I think the algorithm is working... the cases are working and all that, but
the algorithm seems to stop itself midway// does not fully completedIt also is
extremely slow, with aruntime of n^n(very bad runtime :())
/*======================================
  class KnightTour
  Animates a Knight's Tour of a square chess board.

  Mean execution times for boards of size n*n:
  n=5   12_s    over _5 executions
  n=6   n/a_s    over _1_ executions
  n=7   _n/a_s    over _1_ executions
  n=8   _n/a_s    over _1_ executions
  ======================================*/
...
class TourFinder
{
	...
	if (moves==(sideLength  * sideLength ) -1) {
      ...
      System.out.println("All squares traversed");
      //return;
	}
